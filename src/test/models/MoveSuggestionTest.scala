...
class MoveSuggestionTest {
  ...
  @Test def testSuggestMovePawn01(): Unit = {
    ...
    assertEquals(ArrayBuffer((5, 3), (4, 3)), MoveSuggestion.suggestMovePawn(wp01, game.board))
    assertEquals(ArrayBuffer((4, 3)), MoveSuggestion.suggestMovePawn(wp02, game.board))
    ...
    assertEquals(ArrayBuffer((2, 3), (3, 3)), MoveSuggestion.suggestMovePawn(bp01, game.board))
    assertEquals(ArrayBuffer((3, 3)), MoveSuggestion.suggestMovePawn(bp02, game.board))
  ...
  @Test def testSuggestMovePawn02(): Unit = {
    ...
    val wp01 = new Piece(6, 3, "WP3", Color.White, Rank.Pawn, 6, 3)
    game.board(5)(3).value = "WP3"

    // when piece has already moved from its default position
    val wp02 = new Piece(6, 4, "WP4", Color.White, Rank.Pawn, 5, 4)
    game.board(4)(4).value = "WP4"

    assertEquals(ArrayBuffer(), MoveSuggestion.suggestMovePawn(wp01, game.board))
    assertEquals(ArrayBuffer(), MoveSuggestion.suggestMovePawn(wp02, game.board))

    /** piece movement from top of board i.e, black piece side */
    // when piece has not moved from its default position
    val bp01 = new Piece(1, 3, "BP3", Color.Black, Rank.Pawn, 1, 3)
    game.board(2)(3).value = "BP3"

    // when piece has already moved from its default position
    val bp02 = new Piece(1, 4, "BP4", Color.Black, Rank.Pawn, 2, 4)
    game.board(3)(4).value = "BP4"

    assertEquals(ArrayBuffer(), MoveSuggestion.suggestMovePawn(bp01, game.board))
    assertEquals(ArrayBuffer(), MoveSuggestion.suggestMovePawn(bp02, game.board))
  }
  ...
  @Test def testSuggestMovePawn03(): Unit = {
    ...
    assertEquals(ArrayBuffer((5, 3), (4, 3), (5, 2), (5, 4)), MoveSuggestion.suggestMovePawn(wp01, game.board))
    assertEquals(ArrayBuffer((4, 6), (4, 5), (4, 7)), MoveSuggestion.suggestMovePawn(wp02, game.board))
    ...
    assertEquals(ArrayBuffer((2, 3), (3, 3),(2, 2), (2, 4) ), MoveSuggestion.suggestMovePawn(bp11, game.board))
    assertEquals(ArrayBuffer((4, 4), (4, 3), (4, 5)), MoveSuggestion.suggestMovePawn(bp22, game.board))
  }
